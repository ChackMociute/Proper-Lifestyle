...
void create_recipes(ArrayList<Meal> recipes) {
  ...
  recipes.get(1).description = "Description of the recipe, how to\nmake it and so on.";
  ...
  recipes.get(2).description = "Description of the recipe, how to\nmake it and so on.";
  ...
  recipes.get(3).description = "Description of the recipe, how to\nmake it and so on.";
  ...
  recipes.get(4).description = "Description of the recipe, how to\nmake it and so on.";
